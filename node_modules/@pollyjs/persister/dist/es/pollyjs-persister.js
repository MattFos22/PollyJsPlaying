...
class Persister {
  ...
  assert(message, ...args) {
    assert(`[${this.constructor.type}:${this.constructor.name}] ${message}`, ...args);
  }
  /**
  ...
  _removeUnusedEntries(recordingId, har) {
    const requests = this.polly._requests.filter(r => r.recordingId === recordingId && (r.action === ACTIONS.RECORD || r.action === ACTIONS.REPLAY));
