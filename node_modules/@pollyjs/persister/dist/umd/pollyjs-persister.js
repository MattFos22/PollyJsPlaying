...
(function (global, factory) {
  ...
  (global['@pollyjs/persister'] = factory());
  ...
  var browser = bowser && bowser.name && bowser.version ? {
    name: bowser.name,
  ...
  function () {
    ...
    createClass(Log, [{
      ...
      value: function addEntries() {
        ...
        this.entries = uniqWith( // Add the new entries to the front so they take priority
        toConsumableArray(entries).concat(toConsumableArray(this.entries)), function (a, b) {
          return a._id === b._id && a._order === b._order;
        });
        this.sortEntries();
      }
    }, {
      key: "sortEntries",
      value: function sortEntries() {
  ...
  var HAR = function HAR() {
    var opts = arguments.length > 0 && arguments[0] !== undefined ? arguments[0] : {};

    classCallCheck(this, HAR);
  ...
  */
  ...
  function toNVPairs(o) {
    return keys$2(o || {}).map(function (name) {
      return {
        name: name,
        value: o[name]
      };
  ...
  function headersSize(request) {
    var keys = [];
    var values = [];
    request.headers.forEach(function (_ref) {
      var name = _ref.name,
          value = _ref.value;
      keys.push(name);
      values.push(value);
    });
    var headersString = request.method + request.url + keys.join() + values.join(); // startline: [method] [url] HTTP/1.1\r\n = 12
    // endline: \r\n = 2
    // every header + \r\n = * 2
    // add 2 for each combined header

    return browser$1(headersString) + keys.length * 2 + 2 + 12 + 2;
  }
  ...
  var Request = function Request(request) {
    ...
    this.cookies = setCookie.parse(request.getHeader('Set-Cookie'));
    ...
    if (request.hasHeader('Content-Length')) {
      this.bodySize = _parseInt$2(request.getHeader('Content-Length'), 10);
    } else {
      this.bodySize = this.postData && this.postData.text ? browser$1(this.postData.text) : 0;
    }
  };
  ...
  function headersSize$1(response) {
    var keys = [];
    var values = [];
    response.headers.forEach(function (_ref) {
      var name = _ref.name,
          value = _ref.value;
      keys.push(name);
      values.push(value);
    });
    var headersString = keys.join() + values.join(); // endline: \r\n = 2
    // every header + \r\n = * 2
    // add 2 for each combined header

    return browser$1(headersString) + keys.length * 2 + 2 + 2;
  }
  ...
  var Response = function Response(response) {
    ...
    this.cookies = setCookie.parse(response.getHeader('Set-Cookie'));
    this.redirectURL = '';
    this.content = {
    ...
    if (response.hasHeader('Content-Length')) {
      this.content.size = _parseInt$2(response.getHeader('Content-Length'), 10);
    } else {
      this.content.size = this.content.text ? browser$1(this.content.text) : 0;
    }
  ...
  function totalTime() {
    var timings = arguments.length > 0 && arguments[0] !== undefined ? arguments[0] : {};
    return keys$3(timings).reduce(function (total, k) {
      return timings[k] > 0 ? total += timings[k] : total;
    }, 0);
  }

  var Entry = function Entry(request) {
  ...
  var CREATOR_NAME = 'Polly.JS';

  var Persister =
  /*#__PURE__*/
  function () {
    function Persister(polly) {
      classCallCheck(this, Persister);
    ...
    createClass(Persister, [{
      key: "persist",
      value: function () {
        var _persist = asyncToGenerator(
        /*#__PURE__*/
        regenerator.mark(function _callee() {
          var promises, creator, _iteratorNormalCompletion, _didIteratorError, _iteratorError, _iterator, _step, _step$value, recordingId, _step$value$, name, requests, entries, recording, har, _iteratorNormalCompletion2, _didIteratorError2, _iteratorError2, _iterator2, _step2, request, entry;
              ...
              switch (_context.prev = _context.next) {
                ...
                case 2:
                  ...
                  creator = {
                    ...
                    comment: "".concat(this.constructor.type, ":").concat(this.constructor.name)
                  };
                  _iteratorNormalCompletion = true;
                  _didIteratorError = false;
                  _iteratorError = undefined;
                  _context.prev = 7;
                  _iterator = getIterator$1(this.pending);
                ...
                case 9:
                  ...
                  _step$value = slicedToArray(_step.value, 2), recordingId = _step$value[0], _step$value$ = _step$value[1], name = _step$value$.name, requests = _step$value$.requests;
                  entries = [];
                  _context.next = 14;
                  return this.find(recordingId);

                case 14:
                  recording = _context.sent;
                  har = void 0;
                  ...
                  _context.prev = 20;
                  _iterator2 = getIterator$1(requests);
                ...
                case 22:
                  ...
                  this.assert("Cannot persist response for [".concat(entry.request.method, "] ").concat(entry.request.url, " because the status code was ").concat(entry.response.status, " and `recordFailedRequests` is `false`"), request.response.ok || request.config.recordFailedRequests);
                  /*
                  ...
                  */
                  ...
                  _context.next = 28;
                  return request._emit('beforePersist', entry);
          ...
          }, _callee, this, [[7, 54, 58, 66], [20, 34, 38, 46], [39,, 41, 45], [59,, 61, 65]]);
        }));
      ...
      key: "recordRequest",
      value: function recordRequest(pollyRequest) {
        ...
        var recordingId = pollyRequest.recordingId,
            recordingName = pollyRequest.recordingName;

        if (!this.pending.has(recordingId)) {
          this.pending.set(recordingId, {
            name: recordingName,
            requests: []
          });
        }
      ...
      key: "find",
      value: function () {
        var _find = asyncToGenerator(
        /*#__PURE__*/
        regenerator.mark(function _callee3(recordingId) {
          var _this = this;

          var cache, findRecording;
            ...
            while (1) {
              switch (_context3.prev = _context3.next) {
                case 0:
                        ...
                        return regenerator.wrap(function _callee2$(_context2) {
                          while (1) {
                            switch (_context2.prev = _context2.next) {
                              case 0:
                                _context2.next = 2;
                                return _this.findRecording(recordingId);

                              case 2:
                                recording = _context2.sent;
                                ...
                                _this.assert("Recording with id '".concat(recordingId, "' is invalid. Please delete the recording so a new one can be created."), recording.log && recording.log.creator.name === CREATOR_NAME);

                                return _context2.abrupt("return", recording);
                  ...
                  return _context3.abrupt("return", cache.get(recordingId));
      ...
      key: "save",
      value: function () {
        var _save = asyncToGenerator(
        /*#__PURE__*/
        regenerator.mark(function _callee4(recordingId) {
          ...
          return regenerator.wrap(function _callee4$(_context4) {
            while (1) {
              switch (_context4.prev = _context4.next) {
                case 0:
                  _context4.next = 2;
                  return this.saveRecording.apply(this, _args4);
      ...
      value: function () {
        ...
        /*#__PURE__*/
        regenerator.mark(function _callee5(recordingId) {
          ...
          return regenerator.wrap(function _callee5$(_context5) {
            while (1) {
              switch (_context5.prev = _context5.next) {
                case 0:
                  _context5.next = 2;
                  return this.deleteRecording.apply(this, _args5);
      ...
      key: "findEntry",
      value: function () {
        var _findEntry = asyncToGenerator(
        /*#__PURE__*/
        regenerator.mark(function _callee6(pollyRequest) {
          var id, order, recordingId, recording;
          return regenerator.wrap(function _callee6$(_context6) {
            while (1) {
              switch (_context6.prev = _context6.next) {
                case 0:
                  id = pollyRequest.id, order = pollyRequest.order, recordingId = pollyRequest.recordingId;
                  _context6.next = 3;
                  return this.find(recordingId);

                case 3:
                  recording = _context6.sent;
                  return _context6.abrupt("return", recording && recording.log.entries.find(function (entry) {
                    return entry._id === id && entry._order === order;
                  }) || null);
        ...
        return function findEntry(_x4) {
          return _findEntry.apply(this, arguments);
        };
      }()
    }, {
      key: "stringify",
      value: function stringify() {
        return fastJsonStableStringify.apply(void 0, arguments);
      }
    }, {
      key: "assert",
      value: function assert$$1(message) {
        for (var _len = arguments.length, args = new Array(_len > 1 ? _len - 1 : 0), _key = 1; _key < _len; _key++) {
          args[_key - 1] = arguments[_key];
        }

        _assert.apply(void 0, ["[".concat(this.constructor.type, ":").concat(this.constructor.name, "] ").concat(message)].concat(args));
      }
      /**
      ...
      key: "_removeUnusedEntries",
      value: function _removeUnusedEntries(recordingId, har) {
        var requests = this.polly._requests.filter(function (r) {
          return r.recordingId === recordingId && (r.action === ACTIONS.RECORD || r.action === ACTIONS.REPLAY);
        });

        har.log.entries = har.log.entries.filter(function (entry) {
          return requests.find(function (r) {
            return entry._id === r.id && entry._order === r.order;
          });
        });
      }
    }, {
      key: "findRecording",
      value: function findRecording() {
      ...
      get: function get() {
        ...
        return objectSpread({}, this.defaultOptions || {}, (this.polly.config.persisterOptions || {})[name] || {});
      }
    }, {
      key: "hasPending",
      get: function get() {
      ...
      key: "name",
      get: function get() {
        _assert('Must override the static `name` getter.', false);
      }
    }]);
