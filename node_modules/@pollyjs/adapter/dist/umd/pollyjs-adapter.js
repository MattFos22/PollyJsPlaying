...
(function (global, factory) {
  ...
  (global['@pollyjs/adapter'] = factory());
  ...
  function _serialize() {
    _serialize = asyncToGenerator(
    /*#__PURE__*/
    regenerator.mark(function _callee(body) {
  ...
  function _serialize$1() {
    _serialize$1 = asyncToGenerator(
    /*#__PURE__*/
    regenerator.mark(function _callee(body) {
      var data, _iteratorNormalCompletion, _didIteratorError, _iteratorError, _iterator, _step, _step$value, key, value, blobContent;
        ...
        while (1) {
          switch (_context.prev = _context.next) {
            case 0:
              ...
              _context.prev = 5;
              _iterator = getIterator$1(body.entries());
  ...
  function () {
    ...
    createClass(Adapter, [{
      ...
      key: "shouldReRecord",
      value: function shouldReRecord(pollyRequest, recordingEntry) {
        var config = pollyRequest.config;

        if (isExpired(recordingEntry.startedDateTime, config.expiresIn)) {
          if (!config.recordIfExpired) {
            console.warn('[Polly] Recording for the following request has expired but `recordIfExpired` is `false`.\n' + "".concat(recordingEntry.request.method, " ").concat(recordingEntry.request.url, "\n"), recordingEntry);
            return false;
          }

          if (navigator && !navigator.onLine) {
            console.warn('[Polly] Recording for the following request has expired but the browser is offline.\n' + "".concat(recordingEntry.request.method, " ").concat(recordingEntry.request.url, "\n"), recordingEntry);
            return false;
          }
      ...
      key: "timeout",
      value: function timeout$$1(pollyRequest, _ref) {
        var time = _ref.time;
      ...
      key: "handleRequest",
      value: function () {
        var _handleRequest = asyncToGenerator(
        /*#__PURE__*/
        regenerator.mark(function _callee(request) {
          var _this = this;

          var pollyRequest, result;
          return regenerator.wrap(function _callee$(_context) {
            while (1) {
              switch (_context.prev = _context.next) {
                case 0:
                ...
                case 9:
                  ...
                  _context.next = 12;
                  return this.onRequestFinished(pollyRequest, result);
      ...
      key: REQUEST_HANDLER,
      value: function () {
        var _value = asyncToGenerator(
        /*#__PURE__*/
        regenerator.mark(function _callee2(pollyRequest) {
          var mode, interceptor, response;
          return regenerator.wrap(function _callee2$(_context2) {
            while (1) {
              switch (_context2.prev = _context2.next) {
                ...
                case 8:
                  if (!(mode === MODES.PASSTHROUGH || pollyRequest.shouldPassthrough || interceptor && interceptor.shouldPassthrough)) {
                    _context2.next = 10;
                    break;
                  }
                ...
                case 15:
                  ...
                  this.assert("Unhandled request: ".concat(pollyRequest.method, " ").concat(pollyRequest.url, "."), false);
      ...
      key: "passthrough",
      value: function () {
        var _passthrough = asyncToGenerator(
        /*#__PURE__*/
        regenerator.mark(function _callee3(pollyRequest) {
        ...
        return function passthrough(_x3) {
      ...
      value: function () {
        ...
        /*#__PURE__*/
        regenerator.mark(function _callee4(pollyRequest, interceptor) {
            ...
            while (1) {
              switch (_context4.prev = _context4.next) {
                ...
                case 3:
                  ...
                  return _context4.abrupt("return", this.onIntercept(pollyRequest, pollyRequest.response));
        ...
        return function intercept(_x4, _x5) {
      ...
      key: "record",
      value: function () {
        var _record = asyncToGenerator(
        /*#__PURE__*/
        regenerator.mark(function _callee5(pollyRequest) {
          return regenerator.wrap(function _callee5$(_context5) {
            while (1) {
              switch (_context5.prev = _context5.next) {
                case 0:
                  pollyRequest.action = ACTIONS.RECORD;
                  return _context5.abrupt("return", this.onRecord(pollyRequest));
      ...
      key: "replay",
      value: function () {
        var _replay = asyncToGenerator(
        /*#__PURE__*/
        regenerator.mark(function _callee6(pollyRequest) {
          var config, recordingEntry, _recordingEntry$respo, status, statusText, headers, content, normalizedResponse;
            ...
            while (1) {
              switch (_context6.prev = _context6.next) {
                ...
                case 3:
                  ...
                  _context6.next = 7;
                  return pollyRequest._emit('beforeReplay', recordingEntry);
                ...
                case 7:
                  ...
                  return _context6.abrupt("return", this.record(pollyRequest));

                case 9:
                  _context6.next = 11;
                  return this.timeout(pollyRequest, recordingEntry);

                case 11:
                  pollyRequest.action = ACTIONS.REPLAY;
                  _recordingEntry$respo = recordingEntry.response, status = _recordingEntry$respo.status, statusText = _recordingEntry$respo.statusText, headers = _recordingEntry$respo.headers, content = _recordingEntry$respo.content;
                  normalizedResponse = {
                    statusText: statusText,
                    statusCode: status,
                    headers: (headers || []).reduce(function (accum, _ref2) {
                      var name = _ref2.name,
                          value = _ref2.value;
                      accum[name] = value;
                      return accum;
                  ...
                  return _context6.abrupt("return", this.onReplay(pollyRequest, normalizedResponse, recordingEntry));
      ...
      value: function () {
        var _onIdentifyRequest = asyncToGenerator(
        /*#__PURE__*/
        regenerator.mark(function _callee7(pollyRequest) {
          var identifiers, _arr, _i, type;
          ...
          return regenerator.wrap(function _callee7$(_context7) {
            while (1) {
              switch (_context7.prev = _context7.next) {
                ...
                case 7:
                  identifiers.body = _context7.sent;
        ...
        return function onIdentifyRequest(_x8) {
      ...
      value: function onRequestFinished(pollyRequest, result) {
      ...
      key: "onRequestFailed",
      value: function onRequestFailed(pollyRequest, error) {
      ...
      get: function get() {
        ...
        return objectSpread({}, this.defaultOptions || {}, (this.polly.config.adapterOptions || {})[name] || {});
      }
    }, {
      key: "persister",
      get: function get() {
