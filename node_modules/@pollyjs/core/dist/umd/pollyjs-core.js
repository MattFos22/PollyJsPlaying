...
(function (global, factory) {
	...
	function assert (msg, condition) {
	  if (typeof condition === 'undefined' || condition === false) {
	    throw new Error("[Polly] ".concat(msg));
	  }
	}
	...
	var merge = function merge(target, source, options) {
	  ...
	  if (_typeof_1(source) !== 'object') {
	    if (isArray$1(target)) {
	      target.push(source);
	    } else if (_typeof_1(target) === 'object') {
	  ...
	  if (isArray$1(target) && isArray$1(source)) {
	    source.forEach(function (item, i) {
	      if (has$1.call(target, i)) {
	        if (target[i] && _typeof_1(target[i]) === 'object') {
	...
	var compact = function compact(value) {
	  ...
	  for (var i = 0; i < queue.length; ++i) {
	    ...
	    for (var j = 0; j < keys.length; ++j) {
	      ...
	      if (_typeof_1(val) === 'object' && val !== null && refs.indexOf(val) === -1) {
	        queue.push({
	          obj: obj,
	          prop: key
	        });
	...
	var stringify_1 = function stringify_1(object, opts) {
	  ...
	  if (_typeof_1(obj) !== 'object' || obj === null) {
	    return '';
	  }
	  ...
	  for (var i = 0; i < objKeys.length; ++i) {
	    ...
	    pushToArray(keys, stringify$1(obj[key], key, generateArrayPrefix, strictNullHandling, skipNulls, encode ? encoder : null, filter, sort, allowDots, serializeDate, formatter, encodeValuesOnly, charset));
	  }
	...
	function parseQuery(query, options) {
	  return lib.parse(query, objectSpread({
	    plainObjects: true,
	...
	function stringifyQuery(obj) {
	  ...
	  return lib.stringify(obj, objectSpread({
	    addQueryPrefix: true
	  }, options));
	}
	/**
	...
	function arrayFormat(query) {
	  ...
	  try {
	    for (var _iterator = getIterator$1(keys), _step; !(_iteratorNormalCompletion = (_step = _iterator.next()).done); _iteratorNormalCompletion = true) {
	      var key = _step.value;
	...
	function (_URLParse) {
	  ...
	  function URL(url, parse) {
	    ...
	    _this = possibleConstructorReturn(this, getPrototypeOf$2(URL).call(this, url));
	  ...
	  createClass(URL, [{
	    ...
	    value: function set(part, value, fn) {
	      if (part === 'query') {
	        ...
	        return get$3(getPrototypeOf$2(URL.prototype), "set", this).call(this, part, value, parseQuery);
	      }

	      return get$3(getPrototypeOf$2(URL.prototype), "set", this).call(this, part, value, fn);
	    }
	    /**
	    ...
	    value: function toString() {
	      ...
	      return get$3(getPrototypeOf$2(URL.prototype), "toString", this).call(this, function (obj) {
	...
	var FORMATTED_ACTIONS = (_FORMATTED_ACTIONS = {}, defineProperty$3(_FORMATTED_ACTIONS, ACTIONS.RECORD, 'Recorded'), defineProperty$3(_FORMATTED_ACTIONS, ACTIONS.REPLAY, 'Replayed'), defineProperty$3(_FORMATTED_ACTIONS, ACTIONS.INTERCEPT, 'Intercepted'), defineProperty$3(_FORMATTED_ACTIONS, ACTIONS.PASSTHROUGH, 'Passthrough'), _FORMATTED_ACTIONS);
	...
	function () {
	  ...
	  createClass(Logger, [{
	    ...
	    value: function connect() {
	      ...
	      this._middleware = this.polly.server.any().on('response', function () {
	    ...
	    key: "groupStart",
	    value: function groupStart(groupName) {
	    ...
	    value: function logRequest(request) {
	      if (request.config.logging) {
	        ...
	        console.log("".concat(FORMATTED_ACTIONS[request.action], " \u279E ").concat(request.method, " ").concat(request.url, " ").concat(request.response.statusCode, " \u2022 ").concat(request.responseTime, "ms"), request);
	      }
	    }
	  }, {
	    key: "log",
	    value: function log() {
	      this.console.apply(this, ['log'].concat(Array.prototype.slice.call(arguments)));
	    }
	  }, {
	    key: "warn",
	    value: function warn() {
	      this.console.apply(this, ['warn'].concat(Array.prototype.slice.call(arguments)));
	    }
	  }, {
	    key: "error",
	    value: function error() {
	      this.console.apply(this, ['error'].concat(Array.prototype.slice.call(arguments)));
	    }
	  }, {
	    key: "enabled",
	    get: function get() {
	...
	function keyFor(Factory) {
	  return "".concat(Factory.type, ":").concat(Factory.name);
	}
	...
	function () {
	  ...
	  createClass(Container, [{
	    ...
	    value: function register(Factory) {
	      assert("Attempted to register ".concat(Factory, " but invalid factory provided. Expected function, received: \"").concat(_typeof_1(Factory), "\""), typeof Factory === 'function');
	      var type = Factory.type,
	          name = Factory.name;
	      assert("Invalid registration name provided. Expected string, received: \"".concat(_typeof_1(name), "\""), typeof name === 'string');
	      assert("Invalid registration type provided. Expected string, received: \"".concat(_typeof_1(type), "\""), typeof type === 'string');
	...
	function parseUrl(url) {
	  ...
	  var parsedUrl = construct$3(URL, [url].concat(args));
	...
	function url(url) {
	  ...
	  var parsedUrl = parseUrl(url, true); // Remove any url properties that have been disabled via the config
	...
	function headers(headers, config) {
	  ...
	  if (isObjectLike(config) && isArray$4(config.exclude)) {
	...
	function validateRecordingName(name) {
	  assert("Invalid recording name provided. Expected string, received: \"".concat(_typeof_1(name), "\"."), typeof name === 'string');
	...
	function validateRequestConfig(config) {
	  assert("Invalid config provided. Expected object, received: \"".concat(_typeof_1(config), "\"."), isObjectLike(config)); // The following options cannot be overridden on a per request basis
	...
	function () {
	  function HTTPBase() {
	    classCallCheck(this, HTTPBase);

	    this.headers = new HTTPHeaders();
	  }

	  createClass(HTTPBase, [{
	    key: "getHeader",
	...
	/*#__PURE__*/
	function (_HTTPBase) {
	  inherits(PollyResponse, _HTTPBase);

	  function PollyResponse(statusCode, headers, body) {
	    var _this;

	    classCallCheck(this, PollyResponse);

	    _this = possibleConstructorReturn(this, getPrototypeOf$2(PollyResponse).call(this));
	...
	function assertEventName(eventName, eventNames) {
	  assert("Invalid event name provided. Expected string, received: \"".concat(_typeof_1(eventName), "\"."), typeof eventName === 'string');
	  assert("Invalid event name provided: \"".concat(eventName, "\". Possible events: ").concat(toConsumableArray(eventNames).join(', '), "."), eventNames.has(eventName));
	}

	function assertListener(listener) {
	  assert("Invalid listener provided. Expected function, received: \"".concat(_typeof_1(listener), "\"."), typeof listener === 'function');
	}
	...
	function () {
	  ...
	  createClass(EventEmitter, [{
	    ...
	    value: function listeners(eventName) {
	      assertEventName(eventName, this[EVENT_NAMES]);
	      return this.hasListeners(eventName) ? toConsumableArray(this[EVENTS].get(eventName)) : [];
	    }
	    /**
	    ...
	    key: "emit",
	    value: function () {
	      var _emit = asyncToGenerator(
	      /*#__PURE__*/
	      regenerator.mark(function _callee(eventName) {
	        var _len,
	            args,
	            _key,
	          ...
	          while (1) {
	            switch (_context.prev = _context.next) {
	              case 0:
	                ...
	                _context.prev = 6;
	                _iterator = getIterator$1(this.listeners(eventName));
	    ...
	    key: "emitParallel",
	    value: function () {
	      var _emitParallel = asyncToGenerator(
	      /*#__PURE__*/
	      regenerator.mark(function _callee2(eventName) {
	        var _len2,
	            args,
	            _key2,
	            _args2 = arguments;
	      ...
	      return function emitParallel(_x2) {
	    ...
	    value: function emitSync(eventName) {
	      ...
	      if (this.hasListeners(eventName)) {
	        this.listeners(eventName).forEach(function (listener) {
	          var returnValue = listener.apply(void 0, args);
	...
	/*#__PURE__*/
	function (_HTTPBase) {
	  inherits(PollyRequest, _HTTPBase);

	  function PollyRequest(polly, request) {
	    var _this;

	    classCallCheck(this, PollyRequest);

	    _this = possibleConstructorReturn(this, getPrototypeOf$2(PollyRequest).call(this));
	    ...
	    */
	    ...
	    _this.action = null; // Lookup the associated route for this request

	    _this[ROUTE] = polly.server.lookup(_this.method, _this.url); // Handle config overrides defined by the route

	    _this._configure(_this[ROUTE].config()); // Handle recording name override defined by the route


	    var recordingName = _this[ROUTE].recordingName();

	    if (recordingName) {
	      _this._overrideRecordingName(recordingName);
	    }

	    return _this;
	  }

	  createClass(PollyRequest, [{
	    key: "on",
	    value: function on(eventName, listener) {
	    ...
	    key: "respond",
	    value: function () {
	      var _respond = asyncToGenerator(
	      /*#__PURE__*/
	      regenerator.mark(function _callee2(status, headers$$1, body$$1) {
	        return regenerator.wrap(function _callee2$(_context2) {
	          while (1) {
	            switch (_context2.prev = _context2.next) {
	              case 0:
	                assert('Cannot respond to a request that already has a response.', !this.didRespond); // Timestamp the response

	                this.response.timestamp = timestamp(); // Set the status code and headers

	                this.response.status(status).setHeaders(headers$$1); // Set the body without modifying any headers (instead of using .send())

	                this.response.body = body$$1; // Trigger the `beforeResponse` event
	    ...
	    key: "_overrideRecordingName",
	    value: function _overrideRecordingName(recordingName) {
	    ...
	    key: "_identify",
	    value: function () {
	      var _identify2 = asyncToGenerator(
	      /*#__PURE__*/
	          ...
	          while (1) {
	            switch (_context3.prev = _context3.next) {
	              case 0:
	                ...
	                keys$4(NormalizeRequest).forEach(function (key) {
	                  if (_this2[key] && matchRequestsBy[key]) {
	                    _this2.identifiers[key] = NormalizeRequest[key](_this2[key], matchRequestsBy[key]);
	                  }
	              ...
	              case 7:
	                ...
	                this.id = md5(fastJsonStableStringify(this.identifiers)); // Order is calculated on other requests with the same id
	...
	State.prototype.put = function put (char, negate, repeat) {
	    ...
	    else if (isArray$6(this.nextStates)) {
	...
	function _invoke$1() {
	  ...
	  /*#__PURE__*/
	  regenerator.mark(function _callee3(fn, route, req) {
	    var proxyReq,
	        _len,
	        args,
	        _key,
	      ...
	      while (1) {
	        switch (_context3.prev = _context3.next) {
	          ...
	          case 2:
	            ...
	            for (_len = _args3.length, args = new Array(_len > 3 ? _len - 3 : 0), _key = 3; _key < _len; _key++) {
	              args[_key - 3] = _args3[_key];
	            }

	            _context3.next = 6;
	            return fn.apply(void 0, [proxyReq].concat(args));
	...
	function _emit2(_x4, _x5) {
	  return _emit.apply(this, arguments);
	}

	function _emit() {
	  _emit = asyncToGenerator(
	  /*#__PURE__*/
	  regenerator.mark(function _callee4(route, eventName) {
	    var _len2,
	        args,
	        _key2,
	    ...
	    return regenerator.wrap(function _callee4$(_context4) {
	      while (1) {
	        switch (_context4.prev = _context4.next) {
	          case 0:
	            for (_len2 = _args4.length, args = new Array(_len2 > 2 ? _len2 - 2 : 0), _key2 = 2; _key2 < _len2; _key2++) {
	              args[_key2 - 2] = _args4[_key2];
	            }
	            ...
	            _context4.prev = 4;
	            _iterator4 = getIterator$1(route.handlers);
	          ...
	          case 6:
	            ...
	            listeners = handler._eventEmitter.listeners(eventName);
	            _iteratorNormalCompletion5 = true;
	            _didIteratorError5 = false;
	            _iteratorError5 = undefined;
	            _context4.prev = 12;
	            _iterator5 = getIterator$1(listeners);
	          ...
	          case 14:
	            ...
	            _context4.next = 18;
	            return invoke.apply(void 0, [listener, route].concat(args));
	    ...
	    }, _callee4, this, [[4, 40, 44, 52], [12, 23, 27, 35], [28,, 30, 34], [45,, 47, 51]]);
	  }));
	  return _emit.apply(this, arguments);
	}
	...
	function () {
	  ...
	  createClass(Route, [{
	    ...
	    value: function config() {
	      return mergeConfigs.apply(void 0, toConsumableArray(this._orderedHandlers().map(function (handler) {
	    ...
	    key: "intercept",
	    value: function () {
	      var _intercept = asyncToGenerator(
	      /*#__PURE__*/
	      regenerator.mark(function _callee(req, res, interceptor) {
	          ...
	          while (1) {
	            switch (_context.prev = _context.next) {
	              case 0:
	                ...
	                _iteratorError = undefined;
	                _context.prev = 3;
	                _iterator = getIterator$1(this._orderedHandlers());
	              ...
	              case 5:
	                ...
	                _context.next = 10;
	                return invoke.apply(void 0, [handler.get('intercept'), this].concat(Array.prototype.slice.call(_args)));
	      ...
	      return function intercept(_x6, _x7, _x8) {
	          ...
	          while (1) {
	            switch (_context2.prev = _context2.next) {
	              case 0:
	                ...
	                _context2.prev = 3;
	                _iterator2 = getIterator$1(this.middleware);
	              ...
	              case 5:
	                ...
	                m = _step2.value;
	                _context2.next = 9;
	                return _emit2.apply(void 0, [m].concat(Array.prototype.slice.call(_args2)));
	              ...
	              case 26:
	                _context2.next = 28;
	                return _emit2.apply(void 0, [this].concat(Array.prototype.slice.call(_args2)));
	    ...
	    value: function _orderedHandlers() {
	      return toConsumableArray(this.middleware).concat([this]).reduce(function (handlers, route) {
	        handlers.push.apply(handlers, toConsumableArray(route.handlers));
	        return handlers;
	      }, []);
	    }
	  }, {
	...
	function (_Map) {
	  ...
	  function Handler() {
	    ...
	    _this = possibleConstructorReturn(this, getPrototypeOf$2(Handler).call(this));
	  ...
	  createClass(Handler, [{
	    ...
	    value: function intercept(fn) {
	      assert("Invalid intercept handler provided. Expected function, received: \"".concat(_typeof_1(fn), "\"."), typeof fn === 'function');
	...
	var METHODS = ['GET', 'PUT', 'POST', 'DELETE', 'PATCH', 'HEAD', 'OPTIONS'];
	var keys$5 = keys$1;
	...
	function () {
	  ...
	  createClass(Server, [{
	    ...
	    value: function namespace(path, callback) {
	      ...
	      this[NAMESPACES] = toConsumableArray(namespaces).concat([path]);
	      callback(this);
	    ...
	    value: function _buildUrl(path) {
	      return buildUrl.apply(void 0, [this[HOST]].concat(toConsumableArray(this[NAMESPACES]), [path]));
	    }
	    /**
	    ...
	    value: function _registryForHost(host) {
	      if (!this[REGISTRY][host]) {
	        this[REGISTRY][host] = METHODS.reduce(function (acc, method) {
	...
	function () {
	  ...
	  createClass(Polly, [{
	    ...
	    key: "connectTo",
	    value: function connectTo(nameOrFactory) {
	      var container = this.container,
	          adapters = this.adapters;
	      var adapterName = nameOrFactory;
	      ...
	      assert("Adapter matching the name `".concat(adapterName, "` was not registered."), container.has("adapter:".concat(adapterName)));
	      this.disconnectFrom(adapterName);
	      var adapter = new (container.lookup("adapter:".concat(adapterName)))(this);
	      adapter.connect();
	    ...
	    key: "disconnectFrom",
	    value: function disconnectFrom(nameOrFactory) {
	...
	function _beforeEach() {
	  _beforeEach = asyncToGenerator(
	  /*#__PURE__*/
	  regenerator.mark(function _callee(context, recordingName, defaults) {
	    return regenerator.wrap(function _callee$(_context) {
	      while (1) {
	        switch (_context.prev = _context.next) {
	          case 0:
	...
	function _afterEach() {
	  _afterEach = asyncToGenerator(
	  /*#__PURE__*/
	  regenerator.mark(function _callee2(context, framework) {
	    return regenerator.wrap(function _callee2$(_context2) {
	      while (1) {
	        switch (_context2.prev = _context2.next) {
	          case 0:
